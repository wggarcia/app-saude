...
class ContratoSaude(models.Model):
    ...
    operadora          = models.CharField(max_length=300)          # Nome da operadora/seguradora
    numero_contrato    = models.CharField(max_length=100, blank=True, default="")
    registro_ans       = models.CharField(max_length=50, blank=True, default="",
                                          help_text="Registro na ANS (para planos de saúde)")
    ...
    valor_per_capita   = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True,
                                             help_text="Valor por beneficiário/mês")
    ...
    cobertura_detalhes = models.TextField(blank=True, default="",
                                          help_text="Coberturas incluídas no plano")
...
class BeneficiarioContrato(models.Model):
    """Vínculo entre funcionário SST e um contrato de saúde."""
    ...
    dependentes  = models.PositiveSmallIntegerField(default=0,
                                                    help_text="Número de dependentes incluídos")
    criado_em    = models.DateTimeField(auto_now_add=True)
...
class SerieEpidemiologica(models.Model):
    """Série temporal de um indicador epidemiológico — um ponto por período."""
    ...
    nome           = models.CharField(max_length=200)
    descricao      = models.TextField(blank=True, default="")
    unidade        = models.CharField(max_length=50, default="casos",
                                      help_text="Ex: casos, óbitos, internações, taxa/100k")
...
class PontoSerie(models.Model):
    """Um ponto de dados da série epidemiológica."""
