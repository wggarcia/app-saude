...
SITE_TRANSLATIONS = {
    "pt": {
        ...
        "chips": ["Governo", "Farmacia", "Hospital", "SST", "App da populacao"],
        "metrics": [
            {"value": "4 ambientes", "text": "Cada segmento entra em uma experiencia que parece ter sido feita sob medida para a sua rotina"},
        ...
        "ecosystem_title": "Quatro ambientes que parecem feitos sob medida.",
        "ecosystem_lead": "O visitante nao precisa traduzir o produto. Ele reconhece o seu setor, a sua rotina e a sua prioridade logo na primeira tela. Por isso, Governo, Farmacia, Hospital e SST aparecem com identidade propria, valor claro e privacidade preservada.",
        "slides": [
        ...
        "platform": {
            "title_html": "Uma plataforma.<br>Quatro portas de entrada que fazem sentido.",
        ...
        "matrix": [
            ...
            {"label": "Privacidade", "title": "Confianca por segregacao", "text": "Cada ambiente tem login, permissao, dados e auditoria proprios. Governo, farmacia, hospital e SST nao compartilham base operacional entre si."},
        ],
        "values": {
    ...
    "en": {
        "title": "SolusCRT Health | Epidemiology, OSH, Pharmacy, Hospital and Government",
        "description": "SolusCRT Health is a SaaS platform with 4 independent environments: Government with epidemiological situation room, Pharmacy with management and demand radar, Hospital with management and care anticipation, and OSH for organizational management and occupational clinics.",
        ...
        "nav_note": "Private and independent environments by contract",
        "language_aria": "Select language",
        "hero_eyebrow": "Four independent environments. One health platform.",
        ...
        "hero_lead": "SolusCRT Health is a SaaS platform with four completely separate environments: an epidemiological situation room for federal, state and municipal Government; management and demand radar for Pharmacies; care anticipation and hospital management for Hospitals; and complete OSH management with an employee app and team wellness for Companies and occupational clinics. Each segment with its own operations, data and privacy.",
        "actions": {
        ...
        "proofs": [
            {"title": "Government with a real situation room", "text": "Official alerts, IBGE, InfoDengue, InfoGripe and DATASUS in dashboards for federal, state and municipal managers. Decision matrix, audit trail and annual B2G contracts."},
            {"title": "Pharmacy with demand radar", "text": "Pharmaceutical management, inventory, FEFO, traceability and anticipation of medicines and supplies by territory."},
            {"title": "Hospital with care anticipation", "text": "Beds, triage, teams and care pressure prepared before the peak reaches the frontline."},
            {"title": "OSH with employee app", "text": "Medical certificates, incident reports, leave, eSocial OSH, NR training and anonymous wellness in its own occupational environment."},
        ],
        "chips": ["Government", "Pharmacy", "Hospital", "OSH", "Population app"],
        "metrics": [
            {"value": "4 environments", "text": "Government, Pharmacy, Hospital and OSH — each separated by access, data and privacy"},
            {"value": "AI + 10 days", "text": "outbreak anticipation before official data, validated by time series, aggregates and official Brazilian sources"},
            {"value": "100k", "text": "population-standardized indicators for situation room and territorial management"},
            {"value": "LGPD", "text": "minimization, purpose, access control and segregation by environment and segment"},
        ],
        "differential": {
        ...
        "ecosystem_lead": "The population app feeds epidemiological intelligence for government, pharmacy and hospital. OSH runs separately, with an employee app, anonymous wellness and protected occupational data.",
        "slides": [
        ...
        "matrix": [
            ...
            {"label": "Predictive AI", "title": "Epidemiological engine", "text": "Classifies population signals, estimates likely diseases, measures growth and validates gradual decline with time series, aggregates and official Brazilian sources."},
            {"label": "Privacy", "title": "Segment segregation", "text": "Each environment has its own login, permissions, data and audit trail. Government, pharmacy, hospital and OSH do not share the same operational base."},
        ],
        "values": {
        ...
        "app": {
            ...
            "lead": "The app collects symptoms without nominal registration, requires current location to avoid territorial mistakes, shows the local radar and receives official alerts. The experience is simple for the population and valuable for the government situation room, pharmacy and hospital.",
        ...
        "platform": {
            "title_html": "One platform.<br>Four entry points that make sense.",
            ...
            "cards": [
                ...
                },
                {
                    ...
                    "text": "A situation room designed for public authority, territorial response and institutional governance.",
                    "price": "Custom proposal",
                    "caption": "institutional B2G contract",
    ...
    "es": {
        "title": "SolusCRT Salud | Epidemiologia, SST, Farmacia, Hospital y Gobierno",
        "description": "SolusCRT Salud es una plataforma SaaS con 4 ambientes independientes: Gobierno con sala de situacion epidemiologica, Farmacia con gestion y radar de demanda, Hospital con gestion y anticipacion asistencial, y SST para gestion organizacional y clinicas ocupacionales.",
        ...
        "nav_note": "Ambientes privados e independientes bajo contrato",
        "language_aria": "Seleccionar idioma",
        "hero_eyebrow": "Cuatro ambientes independientes. Una plataforma de salud.",
        ...
        "hero_lead": "SolusCRT Salud es una plataforma SaaS con cuatro ambientes completamente separados: sala de situacion epidemiologica para Gobierno federal, estadual y municipal; gestion y radar de demanda para Farmacias; anticipacion asistencial y gestion hospitalaria para Hospitales; y gestion SST completa con app del trabajador y bienestar para Empresas y clinicas ocupacionales. Cada segmento con operacion, datos y privacidad propios.",
        "actions": {
        ...
        "proofs": [
            {"title": "Gobierno con sala de situacion real", "text": "Alertas oficiales, IBGE, InfoDengue, InfoGripe y DATASUS en paneles para gestores federales, estaduales y municipales. Matriz de decision, auditoria y contratos anuales B2G."},
            {"title": "Farmacia con radar de demanda", "text": "Gestion farmaceutica, inventario, FEFO, trazabilidad y anticipacion de medicamentos e insumos por territorio."},
            {"title": "Hospital con anticipacion asistencial", "text": "Camas, triaje, equipos y presion asistencial preparados antes de que el pico llegue a la atencion."},
            {"title": "SST con app del trabajador", "text": "Certificados medicos, accidentes, ausencias, eSocial SST, capacitaciones NR y bienestar anonimo en su propio ambiente ocupacional."},
        ],
        "chips": ["Gobierno", "Farmacia", "Hospital", "SST", "App poblacional"],
        "metrics": [
            {"value": "4 ambientes", "text": "Gobierno, Farmacia, Hospital y SST — cada uno separado por acceso, datos y privacidad"},
            {"value": "IA + 10 dias", "text": "anticipacion de brotes antes del dato oficial, con validacion por serie temporal, agregados y fuentes brasilenas"},
            {"value": "100 mil", "text": "indicadores estandarizados por poblacion para sala de situacion y gestion territorial"},
            {"value": "LGPD", "text": "minimizacion, finalidad, control de acceso y segregacion por ambiente y segmento"},
        ],
        "differential": {
        ...
        "ecosystem_lead": "La app poblacional alimenta la inteligencia epidemiologica de gobierno, farmacia y hospital. El SST opera por separado, con app del trabajador, bienestar anonimo y datos ocupacionales protegidos.",
        "slides": [
        ...
        "matrix": [
            ...
            {"label": "IA predictiva", "title": "Motor epidemiologico", "text": "Clasifica senales poblacionales, estima enfermedades probables, mide crecimiento y valida la reduccion gradual con serie temporal, agregados y fuentes oficiales brasilenas."},
            {"label": "Privacidad", "title": "Segregacion por segmento", "text": "Cada ambiente tiene login, permisos, datos y auditoria propios. Gobierno, farmacia, hospital y SST no comparten la misma base operativa."},
        ],
        "values": {
            "eyebrow": "Valores SolusCRT",
        ...
        "app": {
            ...
            "lead": "La app recoge sintomas sin registro nominal, exige ubicacion actual para evitar error territorial, muestra el radar local y recibe alertas oficiales. La experiencia fue pensada para ser simple para la poblacion y valiosa para la sala de control de gobierno, farmacia y hospital.",
        ...
        "platform": {
            "title_html": "Una plataforma.<br>Cuatro puertas de entrada con sentido.",
            ...
            "cards": [
                ...
                },
                {
                    ...
                    "text": "Una sala de situacion pensada para autoridad publica, respuesta territorial y gobernanza institucional.",
...
PRESENTATION_TRANSLATIONS = {
    "pt": {
        ...
        "vision": {
            "eyebrow": "Visao",
            "title": "Uma plataforma de saude com quatro ambientes privados.",
            "body": "O SolusCRT Saude foi desenhado para que cada decisor se reconheca no produto logo no primeiro contato. Governo encontra comando territorial. Farmacia encontra previsibilidade de demanda. Hospital encontra preparo assistencial. SST encontra organizacao ocupacional, app do funcionario e bem-estar protegido. Sao quatro ambientes privados, com identidade propria, unidos por uma mesma promessa de confianca.",
            "labels": {"resp": "Respiratorio", "deng": "Arbovirose", "covid": "Viral"},
        },
        "problem": {
            "eyebrow": "Problema",
            "title": "Quando tudo parece generico, cada segmento perde tempo, margem, capacidade ou confianca.",
            "cards": [
        ...
        "solution": {
            "eyebrow": "Solucao",
            "title": "Cada segmento entra em um ambiente que fala a sua lingua e protege seus dados.",
        ...
        "ecosystem": {
            "eyebrow": "Ecossistema",
            "title": "Uma plataforma. Quatro ambientes que fazem sentido logo no primeiro olhar.",
            "cards": [
                {"title": "Governo", "text": "Uma sala de situacao epidemiologica feita para autoridade publica, leitura territorial e resposta institucional na esfera federal, estadual e municipal."},
                {"title": "Farmacia", "text": "Gestao farmaceutica, FEFO, lotes, ruptura, compras e inteligencia territorial para antecipar demanda por loja ou rede."},
                ...
                {"title": "SST e Empresas", "text": "SST completo, bem-estar anonimo, app do funcionario, dashboard de funcionarios, KPIs de absenteismo e integracao eSocial SST em uma experiencia pronta para assinatura."},
            ],
        },
        "differential": {
            "eyebrow": "Diferencial",
            "title": "Nao e um unico produto empurrado para todos. E um ecossistema pronto para quatro frentes que colaboram entre si.",
            "body": "O SolusCRT respeita a forma como cada segmento decide. Governo precisa autoridade e governanca. Farmacia precisa previsibilidade e margem. Hospital precisa preparo e capacidade. SST precisa implantacao fluida, assinatura recorrente e uma experiencia que o colaborador percebe.",
            "quote": "Governo enxerga inteligencia territorial. Farmacia enxerga demanda futura. Hospital enxerga preparo assistencial. SST enxerga conformidade com experiencia humana.",
        },
        "governance": {
            "eyebrow": "Governanca",
            "title": "Privacidade, seguranca e segregacao por segmento fazem parte do produto.",
            "cards": [
                {"title": "Ambientes isolados", "text": "Governo, farmacia, hospital e SST possuem acessos, sessoes, trilhas e escopos proprios. O que nasce em um ambiente nao aparece em outro."},
                {"title": "Epidemiologia territorial", "text": "O app da populacao gera sinais anonimos e territoriais para governo, farmacia e hospital, com antifraude, localizacao atual e separacao entre sinal, fonte oficial e inferencia."},
                {"title": "SST e bem-estar protegidos", "text": "ASO, CAT, exames, afastamentos e eSocial sao dados sensiveis. Check-ins de bem-estar sao anonimos por arquitetura e o nome so aparece mediante iniciativa do funcionario."},
                {"title": "Apps e auditoria", "text": "App da populacao e app do funcionario cumprem papeis distintos, com tokens, dispositivos autorizados, notificacoes e revogacao por contrato."},
            ],
        },
        "values": {
            "eyebrow": "Valores",
    ...
    "en": {
        ...
        "vision": {
            "eyebrow": "Vision",
            "title": "One health platform with four private environments.",
            "body": "SolusCRT Health was designed as a sector ecosystem: Government with an epidemiological situation room for federal, state and municipal use; Pharmacy with management and demand radar; Hospital with care management and pressure anticipation; and OSH with occupational compliance, an employee app and anonymous wellness. The population app feeds epidemiological intelligence for the first three without mixing data with OSH.",
        ...
        "governance": {
            ...
            "cards": [
                {"title": "Isolated environments", "text": "Government, pharmacy, hospital and OSH have their own access, sessions, trails and scopes. What is born in one environment does not appear in another."},
    ...
    "es": {
        ...
        "vision": {
            "eyebrow": "Vision",
            "title": "Una plataforma de salud con cuatro ambientes privados.",
            "body": "SolusCRT Salud fue disenado como un ecosistema sectorial: Gobierno con sala de situacion epidemiologica para nivel federal, estadual y municipal; Farmacia con gestion y radar de demanda; Hospital con gestion asistencial y anticipacion de presion; y SST con conformidad ocupacional, app del trabajador y bienestar anonimo. La app poblacional alimenta la inteligencia epidemiologica de los tres primeros sin mezclar datos con SST.",
        ...
        "governance": {
            ...
            "cards": [
                {"title": "Ambientes aislados", "text": "Gobierno, farmacia, hospital y SST tienen sus propios accesos, sesiones, trazas y alcances. Lo que nace en un ambiente no aparece en otro."},
...
LEGAL_DOCUMENTS = {
    "pt": {
        "privacidade": {
            ...
            "subtitle": "Como o SolusCRT Saude trata dados no app da populacao, no app do funcionario e nos ambientes de Governo, Farmacia, Hospital e SST.",
            "sections": [
        ...
        "termos": {
            "title": "Termos de Uso",
            "subtitle": "Regras de uso do app da populacao, do app do funcionario e dos ambientes privados de Governo, Farmacia, Hospital e SST.",
            "sections": [
                ("Natureza da plataforma", "O SolusCRT Saude e uma plataforma SaaS de gestao em saude com quatro ambientes privados e independentes: Governo, Farmacia, Hospital e SST. O app da populacao oferece inteligencia epidemiologica informativa. O app do funcionario atende o ambiente SST. Nenhum dos recursos substitui diagnostico medico, prescricao, triagem clinica individual ou atendimento de emergencia."),
                ...
                ("Ambientes privados", "Acessos de SST, farmacia, hospital, governo e administracao sao exclusivos para clientes e operadores autorizados. Tentativas de acesso indevido podem ser registradas e bloqueadas."),
        ...
        "seguranca-lgpd": {
            ...
            "sections": [
                ...
                ("Dados de governo, farmacia e hospital", "Os ambientes epidemiologicos e operacionais tratam escopos diferentes: governo recebe leitura territorial e governanca; farmacia recebe dados de estoque, lotes e demanda; hospital recebe dados assistenciais e capacidade. Cada ambiente tem trilhas, perfis e autorizacoes proprias."),
    ...
    "en": {
        "privacidade": {
            ...
            "subtitle": "How SolusCRT Health handles data in the population app, the employee app and the Government, Pharmacy, Hospital and OSH environments.",
            "sections": [
        ...
        "termos": {
            "title": "Terms of Use",
            "subtitle": "Rules for using the population app, the employee app and the private Government, Pharmacy, Hospital and OSH environments.",
            "sections": [
                ("Nature of the platform", "SolusCRT Health is a health management SaaS platform with four private and independent environments: Government, Pharmacy, Hospital and OSH. The population app provides informational epidemiological intelligence. The employee app serves the OSH environment. None of these resources replaces medical diagnosis, prescription, individual clinical triage or emergency care."),
                ...
                ("Private environments", "OSH, pharmacy, hospital, government and administrative access is exclusive to clients and authorized operators. Unauthorized access attempts may be recorded and blocked."),
        ...
        "seguranca-lgpd": {
            ...
            "sections": [
                ...
                ("Government, pharmacy and hospital data", "The epidemiological and operational environments treat different scopes: government receives territorial reading and governance; pharmacy receives stock, lots and demand data; hospital receives care and capacity data. Each environment has its own trails, profiles and authorizations."),
    ...
    "es": {
        "privacidade": {
            ...
            "subtitle": "Como SolusCRT Salud trata datos en la app poblacional, la app del trabajador y en los ambientes de Gobierno, Farmacia, Hospital y SST.",
            "sections": [
                ...
                ("Cuatro ambientes, cuatro contextos de tratamiento", "Gobierno trata indicadores territoriales, alertas, auditoria y operacion institucional. Farmacia trata catalogo, inventario, lotes, proveedores, demanda y trazabilidad. Hospital trata triaje, camas, internaciones, prescripciones y operacion asistencial. SST trata certificados medicos, accidentes, examenes, ausencias, eSocial, capacitaciones y bienestar anonimo. La app poblacional alimenta solo la inteligencia epidemiologica territorial; la app del trabajador pertenece al ambiente SST."),
        ...
        "termos": {
            ...
            "subtitle": "Reglas de uso de la app poblacional, la app del trabajador y de los ambientes privados de Gobierno, Farmacia, Hospital y SST.",
            "sections": [
                ("Naturaleza de la plataforma", "SolusCRT Salud es una plataforma SaaS de gestion en salud con cuatro ambientes privados e independientes: Gobierno, Farmacia, Hospital y SST. La app poblacional ofrece inteligencia epidemiologica informativa. La app del trabajador sirve al ambiente SST. Ningun recurso sustituye diagnostico medico, prescripcion, triaje clinico individual ni atencion de emergencia."),
                ...
                ("Ambientes privados", "Los accesos de SST, farmacia, hospital, gobierno y administracion son exclusivos para clientes y operadores autorizados. Intentos de acceso indebido pueden registrarse y bloquearse."),
