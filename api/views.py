...
SITE_TRANSLATIONS = {
    "pt": {
        ...
        "description": "SolusCRT Saude e uma plataforma SaaS com 4 ambientes independentes: Governo com sala de situacao epidemiologica, Farmacia com gestao e radar de demanda, Hospital com gestao e antecipacao assistencial, e SST para gestao organizacional e clinicas ocupacionais.",
        ...
        "nav_note": "Ambientes privados e independentes por contrato",
        "language_aria": "Selecionar idioma",
        "hero_eyebrow": "Quatro ambientes independentes. Uma plataforma de saude.",
        ...
        "hero_lead": "SolusCRT Saude e uma plataforma SaaS com quatro ambientes completamente separados: sala de situacao epidemiologica para Governo federal, estadual e municipal; gestao e radar de demanda para Farmacias; antecipacao assistencial e gestao hospitalar para Hospitais; e gestao SST completa com app do funcionario e bem-estar para Empresas e clinicas ocupacionais. Cada segmento com operacao, dados e privacidade proprios.",
        "actions": {
        ...
        "proofs": [
            {"title": "Governo com sala de situacao real", "text": "Alertas oficiais, IBGE, InfoDengue, InfoGripe e DATASUS em paineis para gestores federais, estaduais e municipais. Matriz de decisao, auditoria e contratos anuais B2G."},
            {"title": "Farmacia com radar de demanda", "text": "Gestao farmaceutica, estoque, FEFO, rastreabilidade e antecipacao de medicamentos e insumos por territorio."},
            {"title": "Hospital com antecipacao assistencial", "text": "Leitos, triagem, equipes e pressao assistencial preparados antes do pico chegar ao atendimento."},
            {"title": "SST com app do funcionario", "text": "ASO, CAT, afastamentos, eSocial SST, treinamentos NR e bem-estar anonimo em ambiente ocupacional proprio."},
        ],
        "chips": ["Governo", "Farmacia", "Hospital", "SST", "App da populacao"],
        "metrics": [
            {"value": "4 ambientes", "text": "Governo, Farmacia, Hospital e SST — cada um separado por acesso, dados e privacidade"},
            {"value": "IA + 10 dias", "text": "antecipacao de surtos antes do dado oficial, com validacao por serie temporal, agregados e fontes brasileiras"},
            {"value": "100 mil", "text": "indicadores padronizados por populacao para sala de situacao e gestao territorial"},
            {"value": "LGPD", "text": "minimizacao, finalidade, controle de acesso e segregacao por ambiente e segmento"},
        ],
        "differential": {
            "title": "A IA do SolusCRT transforma sinais dispersos em decisao antes do pico.",
            "lead": "Ela nao tenta substituir vigilancia oficial nem diagnostico medico. A forca esta em ler milhares de sinais fracos, cruzar territorio, crescimento, sintomas, fontes brasileiras e comportamento temporal para apontar onde agir primeiro — e entregar essa visao ao ambiente certo: governo, farmacia, hospital ou empresa.",
            ...
            "solus_items": [
                ...
                "Entrega a visao ao ambiente correto: sala de situacao para governo, demanda para farmacia, capacidade para hospital.",
            ],
        },
        "ecosystem_title": "Uma arquitetura para todos que precisam agir.",
        "ecosystem_lead": "O app da populacao alimenta a inteligencia epidemiologica de governo, farmacia e hospital. O SST opera separado, com app do funcionario, bem-estar anonimo e dados ocupacionais protegidos.",
        "slides": [
            {"small": "Governo", "title": "Sala de situacao epidemiologica", "text": "Ambiente dedicado para gestores federais, estaduais e municipais com alertas oficiais, IBGE, InfoDengue, InfoGripe, DATASUS, auditoria e matriz de decisao."},
            {"small": "Farmacia", "title": "Gestao farmaceutica com radar", "text": "Controle de estoque, FEFO, lotes, fornecedores e demanda futura de medicamentos e insumos com leitura territorial de risco."},
            {"small": "Hospital", "title": "Gestao hospitalar com antecipacao", "text": "Leitos, triagem, internacoes, equipes e pressao assistencial organizados antes do pico epidemiologico pressionar a porta."},
            {"small": "SST", "title": "Gestao ocupacional independente", "text": "ASO, CAT, afastamentos, exames, NR, EPI/EPC, PGR, eSocial SST, app do funcionario e bem-estar anonimo em ambiente sem dado epidemiologico."},
        ],
        "enterprise": {
            "eyebrow": "Ambiente SST — Empresas e Clinicas Ocupacionais",
            "title": "Gestao SST completa, bem-estar da equipe e app do funcionario em um painel.",
            "lead": "O ambiente SST do SolusCRT e voltado para gestao organizacional pura: empresas de qualquer porte e clinicas de saude ocupacional que precisam de conformidade legal, engajamento do funcionario e visibilidade real do bem-estar da equipe — sem epidemiologia, sem dado externo, com privacidade total.",
            "items": [
                ...
                {"title": "Bem-estar Anonimo da Equipe", "text": "Check-ins anonimos de humor, saude fisica, saude mental, estresse e satisfacao no trabalho. A empresa enxerga tendencias agregadas. O nome do funcionario so aparece se ele voluntariamente solicitar contato de apoio."},
                {"title": "App do Funcionario", "text": "O funcionario acessa o proprio ASO digitalmente, faz solicitacoes, recebe notificacoes de exames e treinamentos e envia check-ins de bem-estar. Mais autonomia, menos papel, mais engajamento real."},
            ],
            "metrics": [
                ...
                {"value": "15 dias gratis", "text": "teste completo sem cartao de credito para o ambiente SST e Empresas"},
            ],
        },
        "matrix": [
            {"label": "Governo", "title": "Sala de situacao", "text": "Paineis para gestores federais, estaduais e municipais com radar territorial, fontes oficiais, comunicacao e auditoria institucional."},
            {"label": "Farmacia", "title": "Radar de demanda", "text": "Antecipacao de demanda, giro, ruptura e insumos com gestao farmaceutica conectada ao risco regional."},
            {"label": "Hospital", "title": "Gestao assistencial", "text": "Preparacao de leitos, triagem, equipes e pressao assistencial com visibilidade de surtos antes do pico chegar ao pronto-socorro."},
            {"label": "SST", "title": "Gestao ocupacional", "text": "ASO, CAT, afastamentos, NR, EPI/EPC, PGR, eSocial SST, app do funcionario e bem-estar anonimo em ambiente proprio, sem dado epidemiologico."},
            {"label": "IA preditiva", "title": "Motor epidemiologico", "text": "Classifica sinais populacionais, estima doencas provaveis, mede crescimento e valida reducao gradual com serie temporal, agregados e fontes brasileiras oficiais."},
            {"label": "Privacidade", "title": "Segregacao por segmento", "text": "Cada ambiente tem login, permissao, dados e auditoria proprios. Governo, farmacia, hospital e SST nao compartilham base operacional entre si."},
        ],
        "values": {
        ...
        "app": {
            ...
            "lead": "O app coleta sintomas sem cadastro nominal, exige localizacao atual para evitar erro territorial, mostra o radar local e recebe alertas oficiais. A experiencia foi pensada para ser simples para a populacao e valiosa para a sala de controle de governo, farmacia e hospital.",
...
PRESENTATION_TRANSLATIONS = {
    "pt": {
        ...
        "vision": {
            ...
            "body": "O SolusCRT Saude foi desenhado como um ecossistema setorial: Governo com sala de situacao epidemiologica para federal, estadual e municipal; Farmacia com gestao e radar de demanda; Hospital com gestao assistencial e antecipacao de pressao; e SST com conformidade ocupacional, app do funcionario e bem-estar anonimo. O app da populacao alimenta a inteligencia epidemiologica dos tres primeiros sem misturar dados com o SST.",
            "labels": {"resp": "Respiratorio", "deng": "Arbovirose", "covid": "Viral"},
        },
        "problem": {
            "eyebrow": "Problema",
            "title": "Cada segmento perde tempo, dinheiro ou capacidade quando tudo vira um unico sistema generico.",
            "cards": [
        ...
        "solution": {
            "eyebrow": "Solucao",
            "title": "Uma arquitetura que entrega a operacao certa, com a privacidade certa.",
            "body": "O SolusCRT separa contratos, logins, indicadores e operacao por segmento. Governo, farmacia e hospital usam inteligencia epidemiologica territorial com a linguagem do seu setor. SST opera como ambiente independente de gestao ocupacional, com assinatura propria, trial de 15 dias e app do funcionario.",
            "cards": [
        ...
        "ecosystem": {
            ...
            "cards": [
                {"title": "Governo", "text": "Sala de situacao epidemiologica, alertas oficiais, matriz de decisao, auditoria, contratos anuais e fontes brasileiras oficiais para esfera federal, estadual e municipal."},
                {"title": "Farmacia", "text": "Gestao farmaceutica, FEFO, lotes, ruptura, compras e integracao epidemiologica para antecipar demanda por loja ou rede."},
