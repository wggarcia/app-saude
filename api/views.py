...
SITE_TRANSLATIONS = {
    ...
    "en": {
        ...
        "metrics": [
            {"value": "5 environments", "text": "Government, Pharmacy, Hospital, OSH and Health Plan — each separated by access, data and privacy"},
        ...
        "ecosystem_lead": "The population app feeds epidemiological intelligence for government, pharmacy and hospital. OSH runs separately, with an employee app, anonymous wellness and protected occupational data. Health Plan operators get their own dedicated management environment.",
        "slides": [
        ...
        "platform": {
            ...
            "cards": [
                ...
                },
                {
                    ...
                    "price": "R$ 12,000",
                    "caption": "/month · annual R$ 120,000 · per operator",
                    "cta": "Request proposal",
                },
            ],
        },
        "footer": "SolusCRT Health. Epidemiological intelligence, government situation room, pharmacy, hospital and health plan management, OSH and population app.",
        "footer_links": {
            "privacy": "Privacy",
            "terms": "Terms",
            "security": "Security",
    ...
    "es": {
        ...
        "metrics": [
            {"value": "5 ambientes", "text": "Gobierno, Farmacia, Hospital, SST y Plan de Salud — cada uno separado por acceso, datos y privacidad"},
        ...
        "ecosystem_lead": "La app poblacional alimenta la inteligencia epidemiologica de gobierno, farmacia y hospital. El SST opera por separado, con app del trabajador, bienestar anonimo y datos ocupacionales protegidos. Las operadoras de plan de salud tienen su propio ambiente de gestion dedicado.",
        "slides": [
        ...
        "footer": "SolusCRT Salud. Inteligencia epidemiologica, sala de situacion para gobierno, gestion para farmacia, hospital, plan de salud, SST y app poblacional.",
        "footer_links": {
            "privacy": "Privacidad",
            "terms": "Terminos",
            "security": "Seguridad",
...
PRESENTATION_TRANSLATIONS = {
    "pt": {
        ...
        "vision": {
            "eyebrow": "Visao",
            "title": "Uma plataforma de saude com cinco ambientes privados.",
            "body": "O SolusCRT Saude foi desenhado para que cada decisor se reconheca no produto logo no primeiro contato. Governo encontra comando territorial. Farmacia encontra previsibilidade de demanda. Hospital encontra preparo assistencial. SST encontra organizacao ocupacional, app do funcionario e bem-estar protegido. Operadoras de Plano de Saude encontram gestao completa de beneficiarios, sinistros, reembolsos e dashboard epidemiologico. Sao cinco ambientes privados, com identidade propria, unidos por uma mesma promessa de confianca.",
        ...
        "ecosystem": {
            "eyebrow": "Ecossistema",
            "title": "Uma plataforma. Cinco ambientes que fazem sentido logo no primeiro olhar.",
            "cards": [
                ...
                {"title": "Plano de Saude", "text": "Gestao completa para operadoras: beneficiarios, contratos, guias de autorizacao, sinistros, reembolsos e dashboard epidemiologico com mapa de calor territorial. 100 usuarios e 100 maquinas autorizadas."},
            ],
        },
        "differential": {
            "eyebrow": "Diferencial",
            "title": "Nao e um unico produto empurrado para todos. E um ecossistema pronto para cinco frentes que colaboram entre si.",
            "body": "O SolusCRT respeita a forma como cada segmento decide. Governo precisa autoridade e governanca. Farmacia precisa previsibilidade e margem. Hospital precisa preparo e capacidade. SST precisa implantacao fluida, assinatura recorrente e uma experiencia que o colaborador percebe. Operadoras de Plano de Saude precisam de gestao especializada de beneficiarios, guias, sinistros e inteligencia territorial.",
            "quote": "Governo enxerga inteligencia territorial. Farmacia enxerga demanda futura. Hospital enxerga preparo assistencial. SST enxerga conformidade com experiencia humana. Plano de Saude enxerga gestao de operadora com epidemiologia.",
        },
        "governance": {
            "eyebrow": "Governanca",
            "title": "Privacidade, seguranca e segregacao por segmento fazem parte do produto.",
            "cards": [
                {"title": "Ambientes isolados", "text": "Governo, farmacia, hospital, SST e plano de saude possuem acessos, sessoes, trilhas e escopos proprios. O que nasce em um ambiente nao aparece em outro."},
