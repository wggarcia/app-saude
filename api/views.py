...
LEGAL_DOCUMENTS = {
    "pt": {
        ...
        "suporte": {
            ...
            "sections": [
                ("Atendimento ao usuario do app da populacao", "Para suporte geral do app da populacao, dificuldades de uso, orientacoes sobre alertas, problemas de mapa ou envio de sintomas, entre em contato por comercial@solocrt.com com o assunto Suporte App SoloCRT."),
                ...
                ("Suporte SST e gestao empresarial", "Empresas com duvidas sobre configuracao SST, integracao eSocial, cadastro de funcionarios, NRs, EPI/EPC, PGR, postos de trabalho ou painel de conformidade podem solicitar suporte tecnico por comercial@solocrt.com com o assunto Suporte SST SoloCRT."),
                ("Privacidade e dados pessoais", "Para pedidos relacionados a privacidade, esclarecimentos sobre tratamento de dados SST ou bem-estar, direitos do titular, exclusao quando aplicavel e temas de LGPD, utilize o canal comercial@solocrt.com com o assunto Privacidade SoloCRT."),
                ("Suporte institucional — farmacia, hospital, governo e plano de saude", "Farmacias, hospitais, municipios, governos e operadoras de plano de saude que precisem de apoio operacional, contratual ou tecnico em seus ambientes especificos podem solicitar atendimento por comercial@solocrt.com."),
    ...
    "en": {
        "privacidade": {
            ...
            "sections": [
                ...
                ("Privacy contact", "Privacy requests, data subject rights, LGPD or privacy questions and requests related to data processing may be sent to comercial@solocrt.com with the subject Privacy SoloCRT."),
        ...
        "suporte": {
            ...
            "sections": [
                ("Population app user support", "For general population app support, difficulty using the app, guidance about alerts, map issues or symptom submission, contact comercial@solocrt.com with the subject SoloCRT App Support."),
                ...
                ("OSH and company management support", "Companies with questions about OSH configuration, eSocial integration, employee records, NR compliance, PPE/EPC, PGR, workstations or compliance dashboards may request technical support at comercial@solocrt.com with the subject SoloCRT OSH Support."),
                ("Privacy and personal data", "For privacy requests, clarification about OSH or wellness data processing, data subject rights, deletion when applicable and LGPD matters, use comercial@solocrt.com with the subject Privacy SoloCRT."),
                ("Institutional support — pharmacy, hospital, government and health plan", "Pharmacies, hospitals, municipalities, governments and health plan operators that need operational, contractual or technical support in their specific environments may contact comercial@solocrt.com."),
    ...
    "es": {
        "privacidade": {
            ...
            "sections": [
                ...
                ("Contacto de privacidad", "Pedidos de privacidad, derechos del titular, dudas sobre LGPD o privacidad y solicitudes relacionadas con tratamiento de datos pueden enviarse a comercial@solocrt.com con el asunto Privacidad SoloCRT."),
        ...
        "suporte": {
            ...
            "sections": [
                ("Atencion al usuario de la app poblacional", "Para soporte general de la app poblacional, dificultades de uso, orientaciones sobre alertas, problemas de mapa o envio de sintomas, contacta comercial@solocrt.com con el asunto Soporte App SoloCRT."),
                ...
                ("Soporte SST y gestion empresarial", "Empresas con dudas sobre configuracion SST, integracion eSocial, registro de trabajadores, NRs, EPI/EPC, PGR, puestos de trabajo o panel de conformidad pueden solicitar soporte tecnico a comercial@solocrt.com con el asunto Soporte SST SoloCRT."),
                ("Privacidad y datos personales", "Para pedidos relacionados con privacidad, aclaraciones sobre tratamiento de datos SST o bienestar, derechos del titular, eliminacion cuando corresponda y temas de LGPD, usa comercial@solocrt.com con el asunto Privacidad SoloCRT."),
                ("Soporte institucional — farmacia, hospital, gobierno y plan de salud", "Farmacias, hospitales, municipios, gobiernos y operadoras de plan de salud que necesiten apoyo operativo, contractual o tecnico en sus ambientes especificos pueden contactar comercial@solocrt.com."),
