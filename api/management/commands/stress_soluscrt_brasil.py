...
REGIOES_BRASIL = [
    ...
    ("Norte", "Amapá", "Macapá", "Centro", 0.0349, -51.0694, "arbovirose"),
    ...
    ("Nordeste", "Ceará", "Fortaleza", "Centro", -3.7319, -38.5267, "arbovirose"),
    ...
    ("Sudeste", "Rio de Janeiro", "Rio de Janeiro", "Centro", -22.9068, -43.1729, "arbovirose"),
    ("Sudeste", "Rio de Janeiro", "Niterói", "Icaraí", -22.8897, -43.1286, "arbovirose"),
    ("Sudeste", "Rio de Janeiro", "São Gonçalo", "Centro", -22.8268, -43.0549, "arbovirose"),
    ("Sudeste", "Rio de Janeiro", "Duque de Caxias", "Centro", -22.7856, -43.3116, "arbovirose"),
    ("Sudeste", "Rio de Janeiro", "Nova Iguaçu", "Centro", -22.7594, -43.4511, "arbovirose"),
    ("Sudeste", "São Paulo", "São Paulo", "Pinheiros", -23.5614, -46.7016, "respiratorio"),
    ("Sudeste", "São Paulo", "Campinas", "Centro", -22.9056, -47.0608, "misto"),
    ("Sul", "Paraná", "Curitiba", "Centro", -25.4284, -49.2733, "respiratorio"),
