...
from api.views_materiais_comerciais import (
    ...
    portfolio_governo as portfolio_materiais_governo,
)
...
from api.views_plano_saude import (
    ...
    api_ps_guia_express_regra, api_ps_guia_express_metricas,
    ...
    api_ps_atuarial,
    api_ps_rpc,
    api_ps_intercambio, api_ps_intercambio_detalhe, api_ps_intercambio_kpis,
    api_ps_rh_contratos, api_ps_rh_token, api_ps_rh_solicitacoes, api_ps_rh_solicitacao_acao,
    api_ps_rh_portal_dados, api_ps_rh_portal_solicitar, plano_portal_rh_page,
    api_ps_sla,
    api_ps_auditoria,
...
from api.views_sst import (
    ...
    api_documentos_sst, api_documento_sst_detalhe,
    api_rede_apoio_sst, api_rede_apoio_sst_detalhe,
    api_afastamentos_sst, api_afastamento_retorno, api_afastamentos_pdf,
    api_exames,
    ...
    api_tipos_treinamento,
    api_tipos_treinamento_detail,
    api_treinamentos_homem_hora,
    api_treinamentos_homem_hora_pdf,
    api_treinamentos_homem_hora_email,
    api_treinamentos_lote,
    sst_home_redirect,
    ...
    api_epis_sem_epi,
    api_epi_inspecoes,
    api_epi_inspecoes_pendentes,
    api_epi_inspecoes_pdf,
    api_instrumentos_medicao,
    api_instrumentos_medicao_detail,
    api_instrumentos_calibracao_pdf,
    api_aso_pdf,
    api_cat_pdf,
    api_prontuario_pdf,
...
from api.views_gestao import (
    ...
    api_2fa_setup, api_2fa_confirmar, api_2fa_desativar, api_2fa_verificar,
    api_plataforma_logs,
    api_benchmark,
    api_dados_empresa,
)
...
from api.views_reuniao_sst import (
    ...
    api_reuniao_token, api_funcionario_reuniao_token,
)
...
from api.views_plano_contas_pagamento import (
    api_contas_abertas,
    api_contas_fechar,
    api_pagamentos_lista,
    api_pagamento_detalhe,
    api_pagamento_acao,
    plano_contas_page,
)
from api.views_plano_portal_prestador import (
    portal_prestador_page,
    api_pp_dados,
    api_pp_enviar_lote,
    api_pp_lote_detalhe,
    api_pp_demonstrativo,
    api_pp_abrir_recurso,
    api_pp_token_gerar,
    api_recursos_lista,
    api_recurso_responder,
    plano_portal_prestador_admin_page,
)
from api.views_plano_coparticipacao import (
    api_copart_regras,
    api_copart_regra_salvar,
    api_copart_evento,
    api_copart_extrato,
    api_copart_consolidar,
    api_copart_auditoria_ans,
    api_copart_simular,
    plano_coparticipacao_page,
)
from api.views_plano_cobranca import (
    api_cob_gerar_faturas,
    api_cob_faturas,
    api_cob_emitir,
    api_cob_remessa,
    api_cob_remessa_download,
    api_cob_conciliar,
    plano_cobranca_page,
)
...
from api.views_governo_teleconsulta import (
    ...
    teleconsulta_sala_paciente,
    api_teleconsulta_kpis,
    api_teleconsulta_lista,
    api_teleconsulta_agendar,
    api_teleconsulta_atualizar,
    api_teleconsulta_sala_token,
    api_teleconsulta_paciente_token,
    api_teleconsulta_paciente_status,
...
from api.views_governo_reuniao import (
    governo_reuniao_page,
    governo_reuniao_sala,
    api_reuniao_gov_lista,
    api_reuniao_gov_criar,
    api_reuniao_gov_atualizar,
    api_reuniao_gov_token,
    api_reuniao_gov_salvar_notas,
    api_reuniao_gov_encerrar,
    api_reuniao_gov_ata,
)
...
from api.views_producao_industrial import (
    producao_industrial_page,
    api_producao_especificacoes,
    api_producao_especificacao_detail,
    api_producao_ordens,
    api_producao_ordem_detail,
    api_producao_preencher_campo,
    api_producao_validar,
    api_producao_avancar,
...
from api.views_hospital_totem import (
    ...
    api_totem_checkin_cpf,
    ps_triagem_interface,
    api_ps_triagem_classificar,
    api_ps_painel,
    api_totem_stats,
    api_totem_checkins_recentes,
    ...
    api_ps_entrada_cadastrar_rosto,
    api_ps_chegadas,
    api_ps_chegada_atender,
    api_exame_resultado,
    api_exames_resultados,
    api_exame_marcar_visto,
)
from api.views_hospital_opme import (
    ...
    api_opme_autorizacao_adequacao,
    api_opme_autorizacao_juntas,
    api_opme_junta_detalhe,
    api_opme_juntas,
    api_opme_esteira,
    api_opme_alternativas,
    api_opme_economia,
    api_opme_anvisa_consulta,
    api_opme_anvisa_buscar,
    api_opme_ans_buscar,
    api_opme_ans_consulta,
    api_opme_ans_tabelas,
    api_opme_ia_modelo,
    api_opme_fornecedores,
    api_opme_fornecedores_verificar_afe,
    api_opme_cotacoes,
    api_opme_cotacao_lances,
    api_opme_cotacao_encerrar,
    api_opme_recebimentos,
    api_opme_recebimento_liberar,
    api_opme_recebimento_acao,
    api_opme_previsibilidade,
    api_opme_sobrepreco,
...
from api.views_hospital_importacao import (
    hospital_importacao_page,
    api_import_tipos,
    api_import_modelo,
    api_import_upload,
    api_import_previa,
    api_import_processar,
    api_import_historico,
)
...
urlpatterns = [
    ...
    path('materiais/governo/', portfolio_materiais_governo),
    ...
    path('farmacia/producao/', producao_industrial_page),
    ...
    path('hospital/importacao/', hospital_importacao_page),
    path('api/hospital/importacao/tipos',                 api_import_tipos),
    path('api/hospital/importacao/modelo/<str:destino>',  api_import_modelo),
    path('api/hospital/importacao/upload',                api_import_upload),
    path('api/hospital/importacao/<int:imp_id>/previa',   api_import_previa),
    path('api/hospital/importacao/<int:imp_id>/processar', api_import_processar),
    path('api/hospital/importacao/historico',             api_import_historico),
    ...
    path('plano-saude/tiss-recepcao/', plano_tiss_recepcao_page),
    path('plano-saude/contas/', plano_contas_page),
    path('plano-saude/portal-prestador/', plano_portal_prestador_admin_page),
    path('api/plano-saude/prestador/<int:prestador_id>/portal-token/', api_pp_token_gerar),
    path('api/plano-saude/recursos/', api_recursos_lista),
    path('api/plano-saude/recursos/<int:recurso_id>/responder/', api_recurso_responder),
    ...
    # Portal do beneficiário por rosto (totem + QR) — acesso público via token
    path('plano-saude/acesso/<str:token>/', portal_facial_page),
    ...
    path('api/plano-saude/cobranca/faturas/<int:fatura_id>/emitir/', api_cob_emitir),
    path('api/plano-saude/cobranca/remessa/', api_cob_remessa),
    path('api/plano-saude/cobranca/remessa/<int:remessa_id>/download/', api_cob_remessa_download),
    path('api/plano-saude/cobranca/conciliar/', api_cob_conciliar),
    path('api/plano-saude/coparticipacao/regras/', api_copart_regras),
    path('api/plano-saude/coparticipacao/regras/salvar/', api_copart_regra_salvar),
    path('api/plano-saude/coparticipacao/evento/', api_copart_evento),
    path('api/plano-saude/coparticipacao/extrato/', api_copart_extrato),
    path('api/plano-saude/coparticipacao/consolidar/', api_copart_consolidar),
    path('api/plano-saude/coparticipacao/auditoria-ans/', api_copart_auditoria_ans),
    path('api/plano-saude/coparticipacao/simular/', api_copart_simular),
    # portal público do prestador (token)
    path('portal-prestador/<str:token>/', portal_prestador_page),
    path('portal-prestador/<str:token>/api/dados/', api_pp_dados),
    path('portal-prestador/<str:token>/api/enviar-lote/', api_pp_enviar_lote),
    path('portal-prestador/<str:token>/api/lote/<int:lote_id>/', api_pp_lote_detalhe),
    path('portal-prestador/<str:token>/api/lote/<int:lote_id>/demonstrativo/', api_pp_demonstrativo),
    path('portal-prestador/<str:token>/api/recurso/', api_pp_abrir_recurso),
    path('api/plano-saude/contas/abertas/', api_contas_abertas),
    path('api/plano-saude/contas/fechar/', api_contas_fechar),
    path('api/plano-saude/contas/pagamentos/', api_pagamentos_lista),
    path('api/plano-saude/contas/pagamentos/<int:pag_id>/', api_pagamento_detalhe),
    path('api/plano-saude/contas/pagamentos/<int:pag_id>/acao/', api_pagamento_acao),
    ...
    path('api/funcionario/reunioes/<int:reuniao_id>/token/', api_funcionario_reuniao_token),
    # colaborador side
    ...
    path('api/sst/documentos/<int:doc_id>', api_documento_sst_detalhe),
    path('api/sst/rede-apoio', api_rede_apoio_sst),
    path('api/sst/rede-apoio/<int:apoio_id>', api_rede_apoio_sst_detalhe),
    ...
    path('api/sst/afastamentos/<int:afastamento_id>/retorno/', api_afastamento_retorno),
    path('api/sst/afastamentos/pdf', api_afastamentos_pdf),
    path('api/sst/afastamentos/pdf/', api_afastamentos_pdf),
    ...
    path('api/sst/treinamentos/lote', api_treinamentos_lote),
    path('api/sst/treinamentos/lote/', api_treinamentos_lote),
    ...
    path('api/sst/epis/sem-epi', api_epis_sem_epi),
    path('api/sst/epis/inspecoes', api_epi_inspecoes),
    path('api/sst/epis/inspecoes/', api_epi_inspecoes),
    path('api/sst/epis/inspecoes/pendentes', api_epi_inspecoes_pendentes),
    path('api/sst/epis/inspecoes/pendentes/', api_epi_inspecoes_pendentes),
    path('api/sst/epis/inspecoes/pdf', api_epi_inspecoes_pdf),
    path('api/sst/epis/inspecoes/pdf/', api_epi_inspecoes_pdf),
    path('api/sst/instrumentos', api_instrumentos_medicao),
    path('api/sst/instrumentos/', api_instrumentos_medicao),
    path('api/sst/instrumentos/pdf', api_instrumentos_calibracao_pdf),
    path('api/sst/instrumentos/pdf/', api_instrumentos_calibracao_pdf),
    path('api/sst/instrumentos/<int:instrumento_id>/', api_instrumentos_medicao_detail),
    path('api/sst/instrumentos/<int:instrumento_id>', api_instrumentos_medicao_detail),
    path('api/sst/treinamentos/tipos', api_tipos_treinamento),
    path('api/sst/treinamentos/tipos/', api_tipos_treinamento),
    path('api/sst/treinamentos/tipos/<int:tipo_id>/', api_tipos_treinamento_detail),
    path('api/sst/treinamentos/tipos/<int:tipo_id>', api_tipos_treinamento_detail),
    path('api/sst/treinamentos/homem-hora', api_treinamentos_homem_hora),
    path('api/sst/treinamentos/homem-hora/', api_treinamentos_homem_hora),
    ...
    path('api/governo/teleconsulta/<int:tc_id>/sala/token/', api_teleconsulta_sala_token),
    path('api/governo/teleconsulta/<int:tc_id>/encerrar/', api_teleconsulta_encerrar),
    path('api/governo/epidemiologia/diagnosticos/', api_diagnosticos_confirmados),
    path('api/governo/reuniao/', api_reuniao_gov_lista),
    path('api/governo/reuniao/criar/', api_reuniao_gov_criar),
    path('api/governo/reuniao/<int:reuniao_id>/atualizar/', api_reuniao_gov_atualizar),
    path('api/governo/reuniao/<int:reuniao_id>/token/', api_reuniao_gov_token),
    path('api/governo/reuniao/<int:reuniao_id>/notas/', api_reuniao_gov_salvar_notas),
    path('api/governo/reuniao/<int:reuniao_id>/encerrar/', api_reuniao_gov_encerrar),
    path('api/governo/reuniao/<int:reuniao_id>/ata/', api_reuniao_gov_ata),
    path('api/teleconsulta/paciente/<str:token>/token/', api_teleconsulta_paciente_token),
    path('api/teleconsulta/paciente/<str:token>/status/', api_teleconsulta_paciente_status),
    path('api/teleconsulta/paciente/<str:token>/tcle/', api_teleconsulta_tcle_aceitar),
    ...
    path('api/farmacia/magistral/kpis/',                                  api_magistral_kpis),
    # ── Ordem de Produção Industrial — motor anti-erro ──────────────────────
    path('api/producao/especificacoes',                                   api_producao_especificacoes),
    path('api/producao/especificacoes/',                                  api_producao_especificacoes),
    path('api/producao/especificacoes/<int:esp_id>',                      api_producao_especificacao_detail),
    path('api/producao/especificacoes/<int:esp_id>/',                     api_producao_especificacao_detail),
    path('api/producao/ordens',                                           api_producao_ordens),
    path('api/producao/ordens/',                                          api_producao_ordens),
    path('api/producao/ordens/<int:op_id>',                               api_producao_ordem_detail),
    path('api/producao/ordens/<int:op_id>/',                              api_producao_ordem_detail),
    path('api/producao/ordens/<int:op_id>/campo',                         api_producao_preencher_campo),
    path('api/producao/ordens/<int:op_id>/campo/',                        api_producao_preencher_campo),
    path('api/producao/ordens/<int:op_id>/validar',                       api_producao_validar),
    path('api/producao/ordens/<int:op_id>/validar/',                      api_producao_validar),
    path('api/producao/ordens/<int:op_id>/avancar',                       api_producao_avancar),
    path('api/producao/ordens/<int:op_id>/avancar/',                      api_producao_avancar),
    ...
    path('api/epidemiologia/simulacao/<str:token>/', panorama_simulacao_nacional),
    ...
    path('api/gestao/2fa/verificar', api_2fa_verificar),
    ...
    path('api/plano-saude/guia-express/regra', api_ps_guia_express_regra),
    path('api/plano-saude/guia-express/metricas', api_ps_guia_express_metricas),
    ...
    path('api/plano-saude/atuarial', api_ps_atuarial),
    path('api/plano-saude/rpc', api_ps_rpc),
    path('api/plano-saude/intercambio/kpis', api_ps_intercambio_kpis),
    path('api/plano-saude/intercambio', api_ps_intercambio),
    path('api/plano-saude/intercambio/<int:gto_id>', api_ps_intercambio_detalhe),
    path('api/plano-saude/rh/contratos', api_ps_rh_contratos),
    path('api/plano-saude/rh/token', api_ps_rh_token),
    path('api/plano-saude/rh/solicitacoes', api_ps_rh_solicitacoes),
    path('api/plano-saude/rh/solicitacoes/<int:sol_id>', api_ps_rh_solicitacao_acao),
    path('api/plano-saude/rh/portal/<str:token>/dados', api_ps_rh_portal_dados),
    path('api/plano-saude/rh/portal/<str:token>/solicitar', api_ps_rh_portal_solicitar),
    path('plano-saude/portal-rh/<str:token>/', plano_portal_rh_page),
    ...
    path('api/hospital/opme/autorizacoes/<int:aut_id>/juntas/',  api_opme_autorizacao_juntas),
    path('api/hospital/opme/autorizacoes/<int:aut_id>/adequacao',  api_opme_autorizacao_adequacao),
    path('api/hospital/opme/autorizacoes/<int:aut_id>/adequacao/', api_opme_autorizacao_adequacao),
    path('api/hospital/opme/autorizacoes/<int:aut_id>/esteira',  api_opme_esteira),
    path('api/hospital/opme/autorizacoes/<int:aut_id>/esteira/', api_opme_esteira),
    path('api/hospital/opme/juntas',                             api_opme_juntas),
    path('api/hospital/opme/juntas/',                            api_opme_juntas),
    path('api/hospital/opme/juntas/<int:junta_id>',              api_opme_junta_detalhe),
    path('api/hospital/opme/juntas/<int:junta_id>/',             api_opme_junta_detalhe),
    path('api/hospital/opme/economia',                           api_opme_economia),
    path('api/hospital/opme/economia/',                          api_opme_economia),
    path('api/hospital/opme/anvisa/consulta',                    api_opme_anvisa_consulta),
    path('api/hospital/opme/anvisa/consulta/',                   api_opme_anvisa_consulta),
    path('api/hospital/opme/anvisa/buscar',                      api_opme_anvisa_buscar),
    path('api/hospital/opme/anvisa/buscar/',                     api_opme_anvisa_buscar),
    path('api/hospital/opme/ans/buscar',                         api_opme_ans_buscar),
    path('api/hospital/opme/ans/buscar/',                        api_opme_ans_buscar),
    path('api/hospital/opme/ans/consulta',                       api_opme_ans_consulta),
    path('api/hospital/opme/ans/consulta/',                      api_opme_ans_consulta),
    path('api/hospital/opme/ans/tabelas',                        api_opme_ans_tabelas),
    path('api/hospital/opme/ans/tabelas/',                       api_opme_ans_tabelas),
    path('api/hospital/opme/ia/modelo',                          api_opme_ia_modelo),
    path('api/hospital/opme/ia/modelo/',                         api_opme_ia_modelo),
    path('api/hospital/opme/fornecedores',                       api_opme_fornecedores),
    path('api/hospital/opme/fornecedores/',                      api_opme_fornecedores),
    path('api/hospital/opme/fornecedores/verificar-afe',         api_opme_fornecedores_verificar_afe),
    path('api/hospital/opme/cotacoes',                           api_opme_cotacoes),
    path('api/hospital/opme/cotacoes/',                          api_opme_cotacoes),
    path('api/hospital/opme/cotacoes/<int:cotacao_id>',          api_opme_cotacao_lances),
    path('api/hospital/opme/cotacoes/<int:cotacao_id>/',         api_opme_cotacao_lances),
    path('api/hospital/opme/cotacoes/<int:cotacao_id>/encerrar', api_opme_cotacao_encerrar),
    path('api/hospital/opme/cotacoes/<int:cotacao_id>/encerrar/', api_opme_cotacao_encerrar),
    path('api/hospital/opme/recebimentos',                       api_opme_recebimentos),
    path('api/hospital/opme/recebimentos/',                      api_opme_recebimentos),
    path('api/hospital/opme/recebimentos/<int:receb_id>/liberar', api_opme_recebimento_liberar),
    path('api/hospital/opme/recebimentos/<int:receb_id>/liberar/', api_opme_recebimento_liberar),
    path('api/hospital/opme/recebimentos/<int:receb_id>/acao', api_opme_recebimento_acao),
    path('api/hospital/opme/recebimentos/<int:receb_id>/acao/', api_opme_recebimento_acao),
    path('api/hospital/opme/previsibilidade',                    api_opme_previsibilidade),
    path('api/hospital/opme/previsibilidade/',                   api_opme_previsibilidade),
    path('api/hospital/opme/sobrepreco',                        api_opme_sobrepreco),
    path('api/hospital/opme/sobrepreco/',                       api_opme_sobrepreco),
    path('api/hospital/opme/catalogo/<int:item_id>/alternativas', api_opme_alternativas),
    path('api/hospital/opme/catalogo/<int:item_id>/alternativas/', api_opme_alternativas),
    ...
    path('api/hospital/totem/checkin-cpf/', api_totem_checkin_cpf),
    path('api/hospital/totem/stats/', api_totem_stats),
    path('api/hospital/totem/checkins/', api_totem_checkins_recentes),
    ...
    path('api/hospital/exames/resultado/', api_exame_resultado),
    path('api/hospital/exames/resultados/', api_exames_resultados),
    path('api/hospital/exames/marcar-visto/', api_exame_marcar_visto),
    ...
    path('api/hospital/ps/entrada/cadastrar-rosto/', api_ps_entrada_cadastrar_rosto),
