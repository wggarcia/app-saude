...
urlpatterns = [
    ...
    path('api/login-modulo', api_login_modulo),
    path('api/login-modulo/', api_login_modulo),
    ...
    path('api/usuarios/modulos', api_atribuir_modulos_usuario),
    ...
    path('api/operacao-central/cliente/criar', api_dono_criar_cliente),
