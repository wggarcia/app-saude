...
BAIRROS = [
    ("Copacabana",      "Rio de Janeiro", "RJ", -22.9711, -43.1823),
    ("Ipanema",         "Rio de Janeiro", "RJ", -22.9838, -43.2096),
    ("Botafogo",        "Rio de Janeiro", "RJ", -22.9444, -43.1867),
    ("Centro",          "Rio de Janeiro", "RJ", -22.9068, -43.1729),
    ("Tijuca",          "Rio de Janeiro", "RJ", -22.9274, -43.2348),
    ("Méier",           "Rio de Janeiro", "RJ", -22.8939, -43.2769),
    ("Madureira",       "Rio de Janeiro", "RJ", -22.8736, -43.3395),
    ("Penha",           "Rio de Janeiro", "RJ", -22.8369, -43.2705),
    ("Barra da Tijuca", "Rio de Janeiro", "RJ", -23.0000, -43.3654),
    ("Bangu",           "Rio de Janeiro", "RJ", -22.8774, -43.4636),
